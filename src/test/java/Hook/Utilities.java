...
public class Utilities {
    ...
    public void checkBox_selected(String xpath_check){
        wait.until(ExpectedConditions.elementToBeSelected(By.xpath(xpath_check)));
    }
    ...
    public void get_text_xpath(String get_xpath,String text_expected){
        wait.until(ExpectedConditions.textToBe(By.xpath(get_xpath), text_expected));
    }
